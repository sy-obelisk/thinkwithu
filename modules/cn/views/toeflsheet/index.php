    ...
    <div class="fraction_content">
        ...
        <div class="fraction_details">
            <div class="content_bd bd">
                <!--外层循环ul  内层循环li-->
                <?php foreach($course['dataCourse'] as $val){?>
                <ul id="panel" class="flex-column" style="display: flex;">
                    ...
                    <li class="flex-cell flex-row course_content">
                        <div class="flex-cell flex-row"><a href=""><p><?php echo $v['name']?></p></a></div>
                        <div class="flex-cell flex-row course_price"><p><?php echo (isset($v['price'])&&is_numeric($v['price'])&&$v['price']!=false)?'￥'.$v['price']:'咨询详情'?></p></div>
                        <div class="flex-cell flex-row course_price"><p><?php echo (isset($v['duration'])&&(int)$v['duration']!=false&&isset($v['price'])&&is_numeric($v['price']))?ceil($v['price']/(int)$v['duration']).'元/课时':'咨询详情'?></p></div>
                        <div class="flex-cell flex-row f15"><p><?php echo $v['commencement']?></p></div>
                        <div class="flex-cell flex-row f15"><p><?php echo $v['duration']?></p></div>
                        <div class="flex-cell flex-row course_try"><a href="http://p.qiao.baidu.com/im/index?siteid=6058744&ucid=3827656&cp=&cr=&cw=" target="_blank">试听</a></div>
                        <div class="flex-cell flex-row course_sign"><a href="http://p.qiao.baidu.com/im/index?siteid=6058744&ucid=3827656&cp=&cr=&cw=">立即报名</a></div>
                    </li>
                    <?php }?>
                </ul>
                <?php }?>
