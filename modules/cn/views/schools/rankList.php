    ...
    <div class="rankListRight">
        ...
        <div class="rightTitle">
           <ul class="rightTitleContent">
               ...
               <a href="/schools-ranking/<?php echo Yii::$app->request->get('classId',296)?>/<?php echo $v['id']?>/1.html" class="<?php echo $v['id']==Yii::$app->request->get('yearId',427)?'on':'';if($v['id']==427) echo ' new';?>"><?php echo $v['name']?></a>
               <?php }?>
           </ul>
        </div>
                ...
                <?php foreach($data['data']['data'] as $k=>$v){?>
                    <li>
                        ...
                        <div class="ContentRight">
                            <a href="/percentages-test.html"><span>录取几率</span></a>
                            <a href=""><span>推荐导师</span></a>
                            <a href="/case.html"><span>热门案例</span></a>
                        </div>
                    </li>
                <?php }?>
            </ul>
