...
<script type="text/javascript">
    function selectPage(_this){
        ...
        location.href ="/writ/aim-<?php echo isset($_GET['aim'])?$_GET['aim']:0?>/country-<?php echo isset($_GET['country'])?$_GET['country']:0?>/page-"+page+str+".html";
    }
    ...
    function clickClassify(){
        ...
        location.href ="/writ/aim-"+aim+"/country-"+country+"/page-1"+".html"
    }
