...
<head>
    ...
    <link rel="stylesheet" href="/cn/gre/css/reset.css">s
                                ...
                                <div class="small_info_wrap">
                                    ...
                                    <div class="small_info">
                                        <span><?php echo date("Y-m-d", strtotime($v['alternatives'])) ?></span><span
                                                class="small_line">|</span><span>关注度:<?php echo $v['viewCount'] ?></span>
                                    </div>
                                </div>
        ...
        <div class="w12">
            <div class="register_enter flex-container-center clearfix">
                ...
                <div class="fr tm">
                    ...
                    <div class="tm register_btn"><a class="inm" href="http://login.viplgw.cn/cn/index/register"
